...
theme.xbackground = "#dae2f099"
theme.xforeground = "#0f0f17"
theme.xcolor0 = "#13141c"
theme.xcolor1 = "#f25c5c"
theme.xcolor2 = "#189e00"
theme.xcolor3 = "#ffb46b"
theme.xcolor4 = "#004ab3"
theme.xcolor5 = "#b22fc2"
theme.xcolor6 = "#11bf9f"
theme.xcolor7 = "#bfc9db"
theme.xcolor8 = "#dae2f099"
theme.xcolor9 = "#f25c5c"
theme.xcolor10 = "#189e00"
theme.xcolor11 = "#ffb46b"
theme.xcolor12 = "#004ab3"
theme.xcolor13 = "#b22fc2"
theme.xcolor14 = "#11bf9f"
theme.xcolor15 = "#858893"
theme.transparent = "#00000000"
theme.xcolor80 = "#e1e6ed"

----------

-- theme.batt_charging = "#b4fbf0"
theme.batt_charging = theme.xcolor2
...
theme.bg_secondary = theme.xcolor8
...
theme.titlebar_close_button_normal = colorize_icon(titlebar_dir .. "inactive.png", theme.xcolor8)
theme.titlebar_close_button_focus  = colorize_icon(titlebar_dir .. "close.png", theme.xcolor1)

theme.titlebar_minimize_button_normal = colorize_icon(titlebar_dir .. "inactive.png", theme.xcolor8)
theme.titlebar_minimize_button_focus  = colorize_icon(titlebar_dir .. "minimize.png", theme.xcolor3)

theme.titlebar_ontop_button_normal_inactive = colorize_icon(titlebar_dir .. "inactive.png", theme.xcolor8)
theme.titlebar_ontop_button_focus_inactive  = titlebar_dir .. "ontop.png"
theme.titlebar_ontop_button_normal_active   = colorize_icon(titlebar_dir .. "inactive.png", theme.xcolor8)
theme.titlebar_ontop_button_focus_active    = titlebar_dir .. "ontop.png"

theme.titlebar_sticky_button_normal_inactive = colorize_icon(titlebar_dir .. "inactive.png", theme.xcolor8)
theme.titlebar_sticky_button_focus_inactive  = titlebar_dir .. "sticky.png"
theme.titlebar_sticky_button_normal_active   = colorize_icon(titlebar_dir .. "inactive.png", theme.xcolor8)
theme.titlebar_sticky_button_focus_active    = titlebar_dir .. "sticky.png"

theme.titlebar_floating_button_normal_inactive = colorize_icon(titlebar_dir .. "inactive.png", theme.xcolor8)
theme.titlebar_floating_button_focus_inactive  = titlebar_dir .. "floating.png"
theme.titlebar_floating_button_normal_active   = colorize_icon(titlebar_dir .. "inactive.png", theme.xcolor8)
theme.titlebar_floating_button_focus_active    = titlebar_dir .. "floating.png"

theme.titlebar_maximized_button_normal_inactive = colorize_icon(titlebar_dir .. "inactive.png", theme.xcolor8)
theme.titlebar_maximized_button_focus_inactive  = colorize_icon(titlebar_dir .. "maximize.png", theme.xcolor2)
theme.titlebar_maximized_button_normal_active   = colorize_icon(titlebar_dir .. "inactive.png", theme.xcolor8)
theme.titlebar_maximized_button_focus_active    = colorize_icon(titlebar_dir .. "maximize.png", theme.xcolor2)
...
-- Taglist
theme.taglist_font = "FantasqueSansMono Nerd Font 13"
theme.taglist_disable_icon = true

theme.taglist_bg_focus    = theme.xforeground .. "cc"
...
-- Separator
theme.separator_color = theme.xcolor8
...
-- Notifications
theme.notification_font = theme.font_name .. "13"
theme.notification_max_width = dpi(800)
theme.notification_max_height = dpi(540)
